                    ...
                    <div class="layui-form-item">
                        <label
                                ...
                                for="LAY-user-login-nickname"></label> <input type="text"
                                                                              ...
                                                                              lay-verify="nickname" placeholder="昵称"
                                                                              class="layui-input">
                    </div>
                    <div class="layui-form-item">
                        <label
                    ...
                    <div class="layui-form-item">
                        <label
                                ...
                                for="LAY-user-login-repass"></label> <input type="password"
                                                                            name="repass" id="LAY-user-login-repass"
                                                                            lay-verify="required"
                    ...
                    <div class="layui-form-item">
                        <label
                                ...
                                for="LAY-user-login-cellphone"></label> <input type="text"
                                                                               name="userPhone"
                                                                               id="LAY-user-login-cellphone"
                                                                               lay-verify="phone" placeholder="手机"
                                                                               class="layui-input">
                    </div>
                    <div class="layui-form-item">
                        <label
