            ...
            <form id="orderForm" action="order/takeOrder" method="post">
                ...
                <table>
                    ...
                    <div class="layui-form-item">
                        ...
                        <button type="button" onclick="javascript:location.href='view/usercenter/#section3'"
                                class="layui-btn layui-btn-lg layui-btn-radius layui-btn-normal">去添加地址
                        </button>
                        </c:if>
                </table>
                    ...
                    <c:forEach items="${cartList }" var="c">
                        <tr>
                            ...
                            <td><a style="text-decoration:none"
                                   href="goods/detail.action?goods.goodsId=${c.cartGoods.goodsId }">${c.cartGoods.goodsName }</a>
                            </td>
                ...
                <hr/>
                <div style='text-align:right;width:1000px;height:50px;font-size:16px;color:red;'><h3>总价：<span
                        id='totalPrice'>0</span>元</h3></div>
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-4"></div>
                    <button type="button"
                            class="btn btn-success btn-lg col-lg-4 col-md-4 col-sm-4"
                            onclick="confirmPre()">确认下单
                    </button>
                </div>
            </form>
        </div>
