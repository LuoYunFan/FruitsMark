...
<form class="layui-form">
    <div class="layui-form-item" style="margin:15px;height:30px;">
        ...
        <input type="text" class="layui-input" style="width:200px;float:left;" id="keyword" name="keyword" value=""
               lay-verify="" placeholder="请输入轮播图名称" autocomplete="off">
    ...
    <form class="layui-form" id="bannerForm">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="bannerName" id="bannerName" required lay-verify="required" value=""
                       class="layui-input"/>
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="bannerUrl" id="bannerUrl" required lay-verify="required" value=""
                       class="layui-input"/>
            </div>
        </div>
        <div class="layui-form-item">
...
<script type="text/javascript">
    ...
    layui.use(['layer', 'table', 'form', 'upload', 'laydate'], function () {
        ...
        //工具条事件监听
        table.on('tool(banner)', function (obj) { //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
