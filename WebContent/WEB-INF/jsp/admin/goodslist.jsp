    ...
    <form id="formData" class="layui-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="goodsName" id="goodsName" required lay-verify="required" placeholder="请输入商品名称"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="goodsPrice" id="goodsPrice" required lay-verify="required"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="goodsNum" id="goodsNum" required lay-verify="required" placeholder="请输入商品库存"
                       value="" class="layui-input"/>
            </div>
        </div>
        <div class="layui-form-item" lay-filter="test">
            ...
            <div class="layui-input-inline">
                <select name="goodsType.typeId" id="goodsType" required lay-verify="required"
                        lay-filter="goods.goodsType.typeId">
                </select>
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="goodsColor" id="goodsColor" required lay-verify="required" value=""
                       class="layui-input"/>
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <textarea name="goodsDesc" id="goodsDesc" required lay-verify="required"
        ...
        table.on('tool(goods)', function (obj) { //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
            ...
            if (layEvent === 'edit') { //编辑
                layer.open({
                    ...
                    btn: ['修改', '取消'],
                    yes: function (index, layero) {//按钮1(修改)的回调
