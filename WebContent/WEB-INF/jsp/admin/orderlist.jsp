...
<form class="layui-form">
    <div class="layui-form-item" style="margin:15px;height:30px;">
        ...
        <input type="text" class="layui-input" style="width:250px;float:left;" id="orderIdKeyword" name="orderIdKeyword"
               value="" lay-verify="" placeholder="请输入快递单号" autocomplete="off">
    ...
    <form id="orderForm" class="layui-form">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="orderId" id="orderId" style='background-color:#F8F8F8;' readonly="readonly"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="orderPrice" id="orderPrice" required lay-verify="required" value=""
                       class="layui-input"/>
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="orderAddress" id="orderAddress" required lay-verify="required" value=""
                       class="layui-input"/>
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="orderUserName" id="orderUserName" required lay-verify="required" value=""
                       class="layui-input"/>
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="orderPhone" id="orderPhone" required lay-verify="required" value=""
                       class="layui-input"/>
            </div>
        </div>
    </form>
